...
const config = {
  "slug": "expat-net-pay-calculator",
  "title": "Expat Net Pay Calculator Malaysia 2026",
  "metaTitle": "Expat Net Pay Calculator Malaysia | Foreign Worker Take-Home 2026",
  "metaDescription": "Calculate expat take-home pay after all deductions. Includes tax, EPF, SOCSO exemptions. Know your real net salary.",
  "h1": "Expat Net Pay Calculator Malaysia 2026",
  "subtitle": "Calculate Foreign Worker Real Take-Home Pay",
  "keywords": [
    "expat net pay",
    "foreign worker salary",
    "expat take home malaysia"
  ],
  "calculationType": "expatNetPay"
};

const faqs = [
  {
    question: 'How do I use the Expat Net Pay Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for expatNetPay scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Expat Net Pay Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const ExpatNetPayCalculator = () => {
