...
const config = {
  "slug": "tp3-income-calculator",
  "title": "TP3 Income Calculator Malaysia 2026",
  "metaTitle": "TP3 Income Calculator Malaysia | Multiple Employer Tax 2026",
  "metaDescription": "Calculate combined income from multiple employers for TP3 form. Aggregate earnings accurately for LHDN filing.",
  "h1": "TP3 Income Calculator Malaysia 2026",
  "subtitle": "Calculate Multiple Employer Income for Tax Filing",
  "keywords": [
    "tp3 calculator",
    "multiple employer tax",
    "tp3 form malaysia"
  ],
  "calculationType": "tp3"
};
...
const faqs = [
  {
    question: 'How do I use the TP3 Income Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for tp3 scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The TP3 Income Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const Tp3IncomeCalculator = () => {
