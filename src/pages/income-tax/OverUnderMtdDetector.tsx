...
const config = {
  "slug": "over-under-mtd-detector",
  "title": "Over/Under MTD Tax Detector Malaysia 2026",
  "metaTitle": "MTD Tax Variance Detector | PCB vs Actual Tax Calculator Malaysia 2026",
  "metaDescription": "Detect if you're paying too much or too little monthly tax. Compare PCB deductions against actual tax liability.",
  "h1": "Over/Under MTD Tax Detector 2026",
  "subtitle": "Are You Overpaying or Underpaying Monthly Tax?",
  "keywords": [
    "mtd tax variance",
    "pcb overpayment",
    "tax underpayment detector"
  ],
  "calculationType": "mtdVariance"
};

const faqs = [
  {
    question: 'How do I use the Over/Under MTD Tax Detector Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for mtdVariance scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Over/Under MTD Tax Detector Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const OverUnderMtdDetector = () => {
