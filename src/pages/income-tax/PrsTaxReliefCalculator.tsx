...
const config = {
  "slug": "prs-tax-relief-calculator",
  "title": "PRS Tax Relief Calculator Malaysia 2026",
  "metaTitle": "PRS Tax Relief Calculator Malaysia | Private Retirement Scheme Tax 2026",
  "metaDescription": "Calculate PRS tax relief benefits. See tax savings from private retirement scheme contributions up to RM3,000.",
  "h1": "PRS Tax Relief Calculator Malaysia 2026",
  "subtitle": "Calculate Tax Benefits of PRS Contributions",
  "keywords": [
    "prs tax relief",
    "private retirement scheme tax",
    "prs deduction"
  ],
  "calculationType": "prsRelief"
};

const faqs = [
  {
    question: 'How do I use the PRS Tax Relief Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for prsRelief scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The PRS Tax Relief Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const PrsTaxReliefCalculator = () => {
