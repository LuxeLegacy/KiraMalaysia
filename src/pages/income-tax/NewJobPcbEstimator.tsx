...
const config = {
  "slug": "new-job-pcb-estimator",
  "title": "New Job PCB Estimator Malaysia 2026",
  "metaTitle": "New Job PCB Calculator Malaysia | First Paycheck Tax 2026",
  "metaDescription": "Estimate PCB deductions at your new job. Know what to expect on your first paycheck. No surprises.",
  "h1": "New Job PCB Estimator Malaysia 2026",
  "subtitle": "Preview Tax Deductions on Your First Paycheck",
  "keywords": [
    "new job tax",
    "first paycheck tax",
    "starting employment tax malaysia"
  ],
  "calculationType": "newJobPcb"
};

const faqs = [
  {
    question: 'How do I use the New Job PCB Estimator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for newJobPcb scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The New Job PCB Estimator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const NewJobPcbEstimator = () => {
