...
const config = {
  ...
  "title": "Rental Income Tax Calculator Malaysia 2026",
  "metaTitle": "Rental Income Tax Calculator Malaysia | Property Rental Tax 2026",
  "metaDescription": "Calculate tax on rental income from properties. Includes allowable deductions like assessment tax, quit rent, repairs.",
  "h1": "Rental Income Tax Calculator Malaysia 2026",
  "subtitle": "Calculate Tax on Property Rental Income",
  "keywords": [
    "rental income tax",
    "property rental tax malaysia",
    "landlord tax"
  ],
  "calculationType": "rentalIncome"
};

const faqs = [
  {
    question: 'How do I use the Rental Income Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for rentalIncome scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Rental Income Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const RentalIncomeTaxCalculator = () => {
