...
const config = {
  "slug": "residency-days-calculator",
  "title": "Tax Residency Days Calculator Malaysia 2026",
  "metaTitle": "Tax Residency Days Calculator Malaysia | 182-Day Threshold Tracker 2026",
  "metaDescription": "Track days in Malaysia to determine tax residency status. Know if you'll hit the 182-day threshold.",
  "h1": "Tax Residency Days Calculator Malaysia 2026",
  "subtitle": "Track Days to Determine Tax Residency Status",
  "keywords": [
    "tax residency calculator",
    "182 day rule",
    "residency status malaysia"
  ],
  "calculationType": "residencyDays"
};

const faqs = [
  {
    question: 'How do I use the Tax Residency Days Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for residencyDays scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Tax Residency Days Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const ResidencyDaysCalculator = () => {
