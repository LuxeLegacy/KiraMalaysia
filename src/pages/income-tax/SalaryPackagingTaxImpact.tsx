...
const config = {
  "slug": "salary-packaging-tax-impact",
  "title": "Salary Packaging Tax Impact Calculator 2026",
  "metaTitle": "Salary Packaging Calculator Malaysia | Allowances vs Base Salary 2026",
  "metaDescription": "Compare tax efficiency of allowances vs base salary. Optimize your salary package structure for maximum take-home.",
  "h1": "Salary Packaging Tax Impact Calculator 2026",
  "subtitle": "Optimize Compensation Structure for Tax Efficiency",
  "keywords": [
    "salary packaging",
    "allowances vs salary",
    "compensation structure tax"
  ],
  "calculationType": "salaryPackaging"
};

const faqs = [
  {
    question: 'How do I use the Salary Packaging Tax Impact Calculator 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for salaryPackaging scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Salary Packaging Tax Impact Calculator 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const SalaryPackagingTaxImpact = () => {
