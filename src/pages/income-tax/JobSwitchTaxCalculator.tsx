...
const config = {
  "slug": "job-switch-tax-calculator",
  "title": "Job Switch Tax Calculator Malaysia 2026",
  "metaTitle": "Job Switch Tax Calculator Malaysia | Mid-Year Employment Change 2026",
  "metaDescription": "Calculate tax when changing jobs mid-year. Handle dual employer income correctly. Avoid surprise tax bills.",
  "h1": "Job Switch Tax Calculator Malaysia 2026",
  "subtitle": "Calculate Tax Impact of Mid-Year Job Change",
  "keywords": [
    "job change tax",
    "switching jobs tax",
    "dual employer tax malaysia"
  ],
  "calculationType": "jobSwitch"
};

const faqs = [
  {
    question: 'How do I use the Job Switch Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for jobSwitch scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Job Switch Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const JobSwitchTaxCalculator = () => {
