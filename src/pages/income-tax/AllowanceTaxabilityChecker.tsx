...
const config = {
  "slug": "allowance-taxability-checker",
  "title": "Allowance Taxability Checker Malaysia 2026",
  "metaTitle": "Allowance Taxability Calculator Malaysia | Benefit-in-Kind Tax 2026",
  "metaDescription": "Check if your allowances are taxable. Calculate benefit-in-kind tax implications. Know the tax on perks.",
  "h1": "Allowance Taxability Checker Malaysia 2026",
  "subtitle": "Determine Tax Implications of Employment Benefits",
  "keywords": [
    "allowance taxability",
    "benefit in kind tax",
    "perks tax malaysia"
  ],
  "calculationType": "allowanceTaxability"
};

const faqs = [
  {
    question: 'How do I use the Allowance Taxability Checker Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for allowanceTaxability scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Allowance Taxability Checker Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const AllowanceTaxabilityChecker = () => {
