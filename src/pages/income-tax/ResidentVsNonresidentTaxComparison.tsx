...
const config = {
  "slug": "resident-vs-nonresident-tax-comparison",
  "title": "Resident vs Non-Resident Tax Comparison 2026",
  "metaTitle": "Resident vs Non-Resident Tax Comparison Malaysia | Rate Comparison 2026",
  "metaDescription": "Compare resident progressive rates vs non-resident 30% flat rate. See which status saves you more tax.",
  "h1": "Resident vs Non-Resident Tax Comparison 2026",
  "subtitle": "Compare Tax Under Different Residency Status",
  "keywords": [
    "resident vs non resident",
    "tax status comparison",
    "expat tax comparison"
  ],
  "calculationType": "residentComparison"
};

const faqs = [
  {
    question: 'How do I use the Resident vs Non-Resident Tax Comparison 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for residentComparison scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Resident vs Non-Resident Tax Comparison 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const ResidentVsNonresidentTaxComparison = () => {
