...
const config = {
  "slug": "bonus-vs-salary-comparison",
  "title": "Bonus vs Salary Comparison Calculator 2026",
  "metaTitle": "Bonus vs Salary Tax Comparison Malaysia | Tax Efficiency 2026",
  "metaDescription": "Should you take a higher salary or larger bonus? Compare tax efficiency of different compensation structures.",
  "h1": "Bonus vs Salary Tax Comparison 2026",
  "subtitle": "Find the Most Tax-Efficient Compensation Structure",
  "keywords": [
    "bonus vs salary tax",
    "compensation tax efficiency",
    "salary structure malaysia"
  ],
  "calculationType": "bonusVsSalary"
};

const faqs = [
  {
    question: 'How do I use the Bonus vs Salary Comparison Calculator 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for bonusVsSalary scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Bonus vs Salary Comparison Calculator 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const BonusVsSalaryComparison = () => {
