...
const config = {
  "slug": "salary-offer-net-calculator",
  "title": "Salary Offer Net Calculator Malaysia 2026",
  "metaTitle": "Job Offer Net Salary Calculator Malaysia | Real Take-Home 2026",
  "metaDescription": "Evaluate job offers accurately. Calculate real take-home from gross salary offered. Compare multiple offers side-by-side.",
  "h1": "Salary Offer Net Calculator 2026",
  "subtitle": "Know Your Real Take-Home Before Accepting Job Offer",
  "keywords": [
    "job offer calculator",
    "salary offer net",
    "compare job offers malaysia"
  ],
  "calculationType": "salaryOffer"
};

const faqs = [
  {
    question: 'How do I use the Salary Offer Net Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for salaryOffer scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Salary Offer Net Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const SalaryOfferNetCalculator = () => {
