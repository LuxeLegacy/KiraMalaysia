...
const config = {
  "slug": "tax-provision-calculator",
  "title": "Tax Provision Calculator Malaysia 2026",
  "metaTitle": "Tax Provision Calculator Malaysia | Self-Employed Tax Set-Aside 2026",
  "metaDescription": "Calculate how much to set aside monthly for annual tax. Essential for self-employed and freelancers.",
  "h1": "Tax Provision Calculator Malaysia 2026",
  "subtitle": "Calculate Monthly Tax Set-Aside Amount",
  "keywords": [
    "tax provision",
    "tax set aside",
    "self employed tax planning"
  ],
  "calculationType": "provision"
};

const faqs = [
  {
    question: 'How do I use the Tax Provision Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for provision scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Tax Provision Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
