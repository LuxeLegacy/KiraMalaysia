...
const config = {
  "slug": "mtd-calculator",
  "title": "MTD Tax Calculator Malaysia 2026",
  "metaTitle": "MTD Tax Calculator Malaysia | Month-to-Date Tax Tracker 2026",
  "metaDescription": "Track your month-to-date income tax. See current month tax with projection for remaining days. Stay on top of your tax.",
  "h1": "MTD (Month-to-Date) Tax Calculator 2026",
  "subtitle": "Track Current Month Tax with Real-Time Projection",
  "keywords": [
    "mtd tax calculator",
    "month to date tax",
    "current month tax malaysia"
  ],
  "calculationType": "mtd"
};
...
const faqs = [
  {
    question: 'How do I use the MTD Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for mtd scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The MTD Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
