...
const config = {
  "slug": "tax-relief-calculator",
  "title": "Tax Relief Calculator Malaysia 2026",
  "metaTitle": "Tax Relief Calculator Malaysia 2026 | Relief Aggregator & Optimizer",
  "metaDescription": "Calculate all tax reliefs you're entitled to. Maximize deductions with comprehensive relief optimizer. Save RM2,000-RM8,000.",
  "h1": "Tax Relief Calculator Malaysia 2026",
  "subtitle": "Maximize All Tax Reliefs You're Entitled To",
  "keywords": [
    "tax relief calculator",
    "relief optimizer",
    "tax deductions malaysia"
  ],
  "calculationType": "relief"
};

const faqs = [
  {
    question: 'How do I use the Tax Relief Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for relief scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Tax Relief Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const TaxReliefCalculator = () => {
