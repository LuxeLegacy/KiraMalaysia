...
const config = {
  "slug": "epf-tax-relief-calculator",
  "title": "EPF Tax Relief Calculator Malaysia 2026",
  "metaTitle": "EPF Tax Relief Calculator Malaysia | Voluntary Contribution Savings 2026",
  "metaDescription": "Calculate tax savings from voluntary EPF contributions. See how much you save while boosting retirement. Double benefit.",
  "h1": "EPF Tax Relief Calculator Malaysia 2026",
  "subtitle": "Calculate Tax Savings from Voluntary EPF Contributions",
  "keywords": [
    "epf tax relief",
    "voluntary epf tax",
    "kwsp tax deduction"
  ],
  "calculationType": "epfRelief"
};

const faqs = [
  {
    question: 'How do I use the EPF Tax Relief Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for epfRelief scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The EPF Tax Relief Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const EpfTaxReliefCalculator = () => {
