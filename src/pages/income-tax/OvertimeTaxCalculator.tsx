...
const config = {
  ...
  "title": "Overtime Tax Calculator Malaysia 2026",
  "metaTitle": "Overtime Tax Calculator Malaysia | Extra Hours Tax Impact 2026",
  "metaDescription": "Calculate tax on overtime pay. See how extra hours affect your take-home. Know your real hourly rate after tax.",
  "h1": "Overtime Tax Calculator Malaysia 2026",
  "subtitle": "Calculate Tax Impact of Overtime Hours",
  "keywords": [
    "overtime tax calculator",
    "overtime pay tax",
    "extra hours tax malaysia"
  ],
...
const faqs = [
  {
    question: 'How do I use the Overtime Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for overtime scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Overtime Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const OvertimeTaxCalculator = () => {
