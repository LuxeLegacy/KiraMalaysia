...
const config = {
  "slug": "raise-negotiation-calculator",
  "title": "Raise Negotiation Calculator Malaysia 2026",
  "metaTitle": "Salary Raise Negotiation Calculator Malaysia | After-Tax Increase 2026",
  "metaDescription": "Negotiate raises effectively. See real take-home increase after tax. Know what gross raise you need for target net increase.",
  "h1": "Raise Negotiation Calculator Malaysia 2026",
  "subtitle": "Calculate Real Take-Home from Salary Increase",
  "keywords": [
    "raise negotiation",
    "salary increase calculator",
    "negotiate salary malaysia"
  ],
  "calculationType": "raiseNegotiation"
};

const faqs = [
  {
    question: 'How do I use the Raise Negotiation Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for raiseNegotiation scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Raise Negotiation Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const RaiseNegotiationCalculator = () => {
