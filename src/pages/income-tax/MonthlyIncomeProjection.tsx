...
const config = {
  "slug": "monthly-income-projection",
  "title": "Monthly Income Projection Tax Calculator 2026",
  "metaTitle": "Monthly Income Projection Malaysia | Variable Salary Tax Smoothing 2026",
  "metaDescription": "Project annual tax from varying monthly income. Smooth out income variations for accurate tax planning.",
  "h1": "Monthly Income Projection Calculator 2026",
  "subtitle": "Project Annual Tax from Variable Monthly Income",
  "keywords": [
    "income projection tax",
    "variable income tax",
    "monthly salary variation"
  ],
  "calculationType": "monthlyProjection"
};

const faqs = [
  {
    question: 'How do I use the Monthly Income Projection Tax Calculator 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for monthlyProjection scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Monthly Income Projection Tax Calculator 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const MonthlyIncomeProjection = () => {
