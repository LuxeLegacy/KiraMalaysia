...
const config = {
  "slug": "payslip-breakdown-calculator",
  "title": "Payslip Breakdown Calculator Malaysia 2026",
  "metaTitle": "Payslip Breakdown Calculator Malaysia | Comprehensive Decoder 2026",
  "metaDescription": "Decode your payslip completely. Understand every deduction, allowance, and benefit. Full transparency.",
  "h1": "Payslip Breakdown Calculator Malaysia 2026",
  "subtitle": "Comprehensive Decoder for Every Payslip Line Item",
  "keywords": [
    "payslip breakdown",
    "decode payslip",
    "understand payslip malaysia"
  ],
  "calculationType": "payslipBreakdown"
};

const faqs = [
  {
    question: 'How do I use the Payslip Breakdown Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for payslipBreakdown scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Payslip Breakdown Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const PayslipBreakdownCalculator = () => {
