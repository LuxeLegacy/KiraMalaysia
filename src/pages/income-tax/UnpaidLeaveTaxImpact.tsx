...
const config = {
  "slug": "unpaid-leave-tax-impact",
  "title": "Unpaid Leave Tax Impact Calculator 2026",
  "metaTitle": "Unpaid Leave Tax Calculator Malaysia | Salary Reduction Tax 2026",
  "metaDescription": "Calculate tax impact of unpaid leave periods. Adjust annual tax estimates for reduced income months.",
  "h1": "Unpaid Leave Tax Impact Calculator 2026",
  "subtitle": "Calculate Tax Adjustment for Unpaid Leave Periods",
  "keywords": [
    "unpaid leave tax",
    "salary reduction tax",
    "leave without pay tax"
  ],
  "calculationType": "unpaidLeave"
};

const faqs = [
  {
    question: 'How do I use the Unpaid Leave Tax Impact Calculator 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for unpaidLeave scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Unpaid Leave Tax Impact Calculator 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const UnpaidLeaveTaxImpact = () => {
