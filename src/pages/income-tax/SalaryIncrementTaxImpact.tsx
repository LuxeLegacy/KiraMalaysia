...
const config = {
  "slug": "salary-increment-tax-impact",
  "title": "Salary Increment Tax Impact Calculator 2026",
  "metaTitle": "Salary Increment Tax Calculator Malaysia | Raise Tax Impact 2026",
  "metaDescription": "Calculate how much of your salary increase you'll actually keep after tax. See before vs after comparison.",
  "h1": "Salary Increment Tax Impact Calculator 2026",
  "subtitle": "See Real Impact of Your Salary Increase After Tax",
  "keywords": [
    "salary increment tax",
    "raise tax impact",
...
const faqs = [
  {
    question: 'How do I use the Salary Increment Tax Impact Calculator 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for increment scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Salary Increment Tax Impact Calculator 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const SalaryIncrementTaxImpact = () => {
