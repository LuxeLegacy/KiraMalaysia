...
const config = {
  ...
  "title": "Side Income Tax Set-Aside Calculator 2026",
  "metaTitle": "Side Income Tax Calculator Malaysia | Additional Income Tax Planning 2026",
  "metaDescription": "Calculate how much to set aside from side income for tax. Plan for additional income streams correctly.",
  "h1": "Side Income Tax Set-Aside Calculator 2026",
  "subtitle": "Calculate Tax Provision for Additional Income Streams",
  "keywords": [
    "side income tax",
    "additional income tax",
    "part time income tax"
  ],
  "calculationType": "sideIncome"
};

const faqs = [
  {
    question: 'How do I use the Side Income Tax Set-Aside Calculator 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for sideIncome scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Side Income Tax Set-Aside Calculator 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const SideIncomeTaxSetAside = () => {
