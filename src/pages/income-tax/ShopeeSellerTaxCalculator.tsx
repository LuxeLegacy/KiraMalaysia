...
const config = {
  "slug": "shopee-seller-tax-calculator",
  "title": "Shopee Seller Tax Calculator Malaysia 2026",
  "metaTitle": "Shopee Seller Tax Calculator Malaysia | E-Commerce Income Tax 2026",
  "metaDescription": "Calculate income tax for Shopee sellers. Includes cost of goods and platform fees. Essential for online sellers.",
  "h1": "Shopee Seller Tax Calculator Malaysia 2026",
  "subtitle": "Calculate E-Commerce Income Tax After Costs",
  "keywords": [
    "shopee seller tax",
    "e commerce tax",
    "online business tax malaysia"
  ],
  "calculationType": "shopeeSeller"
};

const faqs = [
  {
    question: 'How do I use the Shopee Seller Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for shopeeSeller scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Shopee Seller Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const ShopeeSellerTaxCalculator = () => {
