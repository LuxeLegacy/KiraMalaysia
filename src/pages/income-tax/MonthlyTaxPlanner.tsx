...
const config = {
  "slug": "monthly-tax-planner",
  "title": "Monthly Tax Planner Malaysia 2026",
  "metaTitle": "Monthly Tax Planner Malaysia | Forward-Looking Tax Planning 2026",
  "metaDescription": "Plan your monthly tax obligations ahead. Project future tax liability and optimize deductions proactively.",
  "h1": "Monthly Tax Planner Malaysia 2026",
  "subtitle": "Plan Future Tax Obligations Month by Month",
  "keywords": [
    "monthly tax planner",
    "tax planning malaysia",
    "monthly tax projection"
  ],
  "calculationType": "monthlyPlanner"
};

const faqs = [
  {
    question: 'How do I use the Monthly Tax Planner Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for monthlyPlanner scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Monthly Tax Planner Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const MonthlyTaxPlanner = () => {
