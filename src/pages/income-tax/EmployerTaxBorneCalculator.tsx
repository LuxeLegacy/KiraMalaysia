...
const config = {
  "slug": "employer-tax-borne-calculator",
  "title": "Employer Tax Borne Calculator Malaysia 2026",
  "metaTitle": "Employer Tax Borne Calculator Malaysia | Tax-Inclusive Salary 2026",
  "metaDescription": "Calculate tax-inclusive salary packages where employer bears the tax. Know gross required for target net.",
  "h1": "Employer Tax Borne Calculator Malaysia 2026",
  "subtitle": "Calculate Tax-Inclusive Compensation Packages",
  "keywords": [
    "employer tax borne",
    "tax inclusive salary",
    "tax borne by employer"
  ],
  "calculationType": "employerTaxBorne"
};

const faqs = [
  {
    question: 'How do I use the Employer Tax Borne Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for employerTaxBorne scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Employer Tax Borne Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const EmployerTaxBorneCalculator = () => {
