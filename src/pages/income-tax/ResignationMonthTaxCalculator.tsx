...
const config = {
  "slug": "resignation-month-tax-calculator",
  "title": "Resignation Month Tax Calculator Malaysia 2026",
  "metaTitle": "Resignation Month Tax Calculator | Partial Month Employment Tax 2026",
  "metaDescription": "Calculate tax for partial month employment when resigning. Get accurate final paycheck tax deduction.",
  "h1": "Resignation Month Tax Calculator 2026",
  "subtitle": "Calculate Tax for Your Final Paycheck",
  "keywords": [
    "resignation tax",
    "final paycheck tax",
    "partial month tax malaysia"
  ],
  "calculationType": "resignation"
};

const faqs = [
  {
    question: 'How do I use the Resignation Month Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for resignation scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Resignation Month Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const ResignationMonthTaxCalculator = () => {
