...
const config = {
  ...
  "title": "Tax Refund Calculator Malaysia 2026",
  "metaTitle": "Tax Refund Calculator Malaysia | LHDN Refund Estimator 2026",
  "metaDescription": "Find out if LHDN owes you money. Calculate tax overpayment and refund amount. Most Malaysians get back RM2,000-RM5,000.",
  "h1": "Tax Refund Calculator Malaysia 2026",
  "subtitle": "Discover If LHDN Owes You Money (Average Refund: RM3,200)",
  "keywords": [
    "tax refund calculator malaysia",
    "lhdn refund",
    "tax overpayment",
    "tax rebate malaysia"
  ],
...
const faqs = [
  {
    question: 'How do I use the Tax Refund Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for refund scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Tax Refund Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const TaxRefundCalculator = () => {
