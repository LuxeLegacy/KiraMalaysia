...
const config = {
  "slug": "insurance-relief-calculator",
  "title": "Insurance Relief Calculator Malaysia 2026",
  "metaTitle": "Insurance Tax Relief Calculator Malaysia | Life & Medical Premium 2026",
  "metaDescription": "Calculate tax relief from life and medical insurance premiums. Maximize your RM3,000 insurance relief claim.",
  "h1": "Insurance Tax Relief Calculator Malaysia 2026",
  "subtitle": "Calculate Tax Relief from Insurance Premiums",
  "keywords": [
    "insurance tax relief",
    "life insurance relief",
    "medical insurance tax deduction"
  ],
  "calculationType": "insuranceRelief"
};

const faqs = [
  {
    question: 'How do I use the Insurance Relief Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for insuranceRelief scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Insurance Relief Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const InsuranceReliefCalculator = () => {
