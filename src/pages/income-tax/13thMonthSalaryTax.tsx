...
const config = {
  "slug": "13th-month-salary-tax",
  "title": "13th Month Salary Tax Calculator Malaysia 2026",
  "metaTitle": "13th Month Salary Tax Calculator | Year-End Bonus Tax Malaysia 2026",
  "metaDescription": "Calculate tax on your 13th month salary. Optimize reliefs to reduce tax on year-end bonus. Save up to RM2,000.",
  "h1": "13th Month Salary Tax Calculator 2026",
  "subtitle": "Calculate Year-End Bonus Tax with Relief Optimization",
  "keywords": [
    "13th month salary tax",
    "year end bonus tax",
    "december bonus tax malaysia"
  ],
  "calculationType": "thirteenthMonth"
};

const faqs = [
  {
    question: 'How do I use the 13th Month Salary Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for thirteenthMonth scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The 13th Month Salary Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const ThirteenthMonthSalaryTax = () => {
