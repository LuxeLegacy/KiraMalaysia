...
const config = {
  "slug": "non-resident-tax-calculator",
  "title": "Non-Resident Tax Calculator Malaysia 2026",
  "metaTitle": "Non-Resident Tax Calculator Malaysia | 30% Flat Rate Calculator 2026",
  "metaDescription": "Calculate non-resident income tax at 30% flat rate. Compare against resident rates. Critical for expats and foreign workers.",
  "h1": "Non-Resident Tax Calculator Malaysia 2026",
  "subtitle": "Calculate Tax at 30% Non-Resident Flat Rate",
  "keywords": [
    "non resident tax",
    "expat tax malaysia",
    "30 percent tax rate"
  ],
  "calculationType": "nonResident"
};

const faqs = [
  {
    question: 'How do I use the Non-Resident Tax Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for nonResident scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Non-Resident Tax Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const NonResidentTaxCalculator = () => {
