...
const config = {
  ...
  "title": "Effective Tax Rate Calculator Malaysia 2026",
  "metaTitle": "Effective Tax Rate Calculator Malaysia | True Tax Rate 2026",
  "metaDescription": "Calculate your true effective tax rate. See what percentage of income actually goes to tax after all reliefs.",
  "h1": "Effective Tax Rate Calculator Malaysia 2026",
  "subtitle": "Calculate Your True Average Tax Rate",
  "keywords": [
    "effective tax rate",
    "average tax rate malaysia",
    "true tax percentage"
  ],
  "calculationType": "effectiveRate"
};

const faqs = [
  {
    question: 'How do I use the Effective Tax Rate Calculator Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for effectiveRate scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Effective Tax Rate Calculator Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const EffectiveTaxRateCalculator = () => {
