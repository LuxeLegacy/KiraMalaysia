...
const config = {
  "slug": "ytd-tax-tracker",
  "title": "YTD Tax Tracker Malaysia 2026",
  "metaTitle": "YTD Tax Tracker Malaysia | Year-to-Date Income Tax Calculator 2026",
  "metaDescription": "Track year-to-date cumulative tax with remaining year projection. Stay ahead of your annual tax liability.",
  "h1": "YTD (Year-to-Date) Tax Tracker 2026",
  "subtitle": "Track Cumulative Tax with End-of-Year Projection",
  "keywords": [
    "ytd tax tracker",
    "year to date tax",
    "cumulative tax malaysia",
...
const faqs = [
  {
    question: 'How do I use the YTD Tax Tracker Malaysia 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for ytd scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The YTD Tax Tracker Malaysia 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
