...
const config = {
  "slug": "company-a-vs-company-b-salary-comparison",
  "title": "Company Salary Comparison Calculator 2026",
  "metaTitle": "Job Offer Comparison Calculator Malaysia | Side-by-Side Salary Analysis 2026",
  "metaDescription": "Compare job offers side-by-side after tax. See real take-home difference. Make informed career decisions.",
  "h1": "Company A vs B Salary Comparison 2026",
  "subtitle": "Compare Multiple Job Offers After Tax Side-by-Side",
  "keywords": [
    "compare job offers",
    "salary comparison",
    "job offer calculator"
  ],
  "calculationType": "companyComparison"
};

const faqs = [
  {
    question: 'How do I use the Company Salary Comparison Calculator 2026?',
  ...
  },
  {
    ...
    answer: 'Use this whenever you need to plan taxes, compare offers, or understand your tax obligations for companyComparison scenarios.'
  }
];

const educationalContent = {
  whatIsIt: 'The Company Salary Comparison Calculator 2026 helps you calculate income tax for specific scenarios using official Malaysian tax rates and regulations for 2026.',
...
export const CompanyAVsCompanyBSalaryComparison = () => {
